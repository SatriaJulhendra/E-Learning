                ...
                <Container>
                    <Row className="header-box  d-flex align-items-center pt-lg-5">
                        <Col lg="6" >
                            ...
                            <p className="mb-4 animate__animated animate__fadeInUp animate__delay-1s">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Saepe accusantium aliquid nostrum molestias et iusto.</p>
                ...
                <Container >
                        ...
                        {kelasTerbaru.map((kelas) =>{
                            return(
                                <Col key={kelas.id} className="shadow rounded" data-aos="fade-up" data-aos-duration= "1000" data-aos-delay = {kelas.delay} >
                                    <img src={kelas.image} alt="unsplas.com" className="w-100 mb-5 rounded-top-2" />
                    ...
                    <Row>
                        <Col className="text-center ">
                            <button className= "btn btn-success rounded-5 btn-lg" data-aos="fade-up" data-aos-duration="1000" onClick={() => navigate("/kelas")}>Lihat Semua Kelas <i className="fa-solid fa-chevron-right ms-3"></i> </button> 
                        </Col>
                    </Row>
                </Container>
            </div>
                        ...
                        {dataSwiper.map((data) =>{
                            return(
                                <SwiperSlide key={data.id} className="shadow-sm " >
                                    ...
                                    <div className="People d-flex justify-content-center justify-content-lg-start">
                                        <img src={data.image} alt="unsplas.com" className="rounded-circle" />
                                        <div>
